# Form implementation generated from reading ui file 'ui_file/settings.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog, theme):
        ...
        self.ac_box.setGeometry(QtCore.QRect(200, 80, 181, 131))
        self.ac_box.setObjectName("ac_box")
        self.iuser = QtWidgets.QLineEdit(parent=self.ac_box)
        self.iuser.setGeometry(QtCore.QRect(10, 30, 141, 25))
        self.iuser.setStyleSheet("background-color: rgb(239, 241, 255)")
        self.iuser.setObjectName("iuser")
        self.ipass = QtWidgets.QLineEdit(parent=self.ac_box)
        self.ipass.setGeometry(QtCore.QRect(10, 70, 141, 25))
        self.ipass.setStyleSheet("background-color: rgb(239, 241, 255)")
        self.ipass.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.ipass.setObjectName("ipass")
        self.pshow1 = QtWidgets.QCheckBox(parent=self.ac_box)
        self.pshow1.setGeometry(QtCore.QRect(10, 100, 121, 23))
        self.pshow1.setObjectName("pshow1")
        self.t_box = QtWidgets.QGroupBox(parent=Dialog)
        self.t_box.setGeometry(QtCore.QRect(200, 0, 181, 71))
        self.t_box.setObjectName("t_box")
        self.theme = QtWidgets.QComboBox(parent=self.t_box)
        self.theme.setGeometry(QtCore.QRect(10, 30, 141, 25))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ac_box.setTitle(_translate("Dialog", "Instagram hesap bilgileri"))
        self.iuser.setPlaceholderText(_translate("Dialog", "Kullanıcı adı"))
